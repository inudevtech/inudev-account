...
import { logout, onAuthStateChanged, resetPassword } from '../util/firebase/auth';
      ...
      if (executeRecaptcha) {
        executeRecaptcha!('upload').then(async (recaptcha) => {
          if (iconURL !== null) {
            ...
            axios.post(`${process.env.NEXT_PUBLIC_HOTDOG_URL}/api/upload`, byteString, { params })
              .then((res) => {
            ...
            <div className="flex gap-2 flex-col md:flex-row items-start">
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  ...
                  アップロード
                  <input type="file" id="upload" className="hidden" accept="image/png, image/jpeg, image/webp" />
                </label>
                <button
                  type="button"
                  onClick={remove}
